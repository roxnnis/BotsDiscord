...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (typeof rolistes[NomDonne] !== "undefined") { //Requête par nom trouve une correspondance dans base JSON
      embed = new MessageEmbed()
		...
		.addFields(
			...
			{name:"Niveau", value:rolistes[NomDonne].LVL.toString(), inline:true},
			{name:"Argent", value:rolistes[NomDonne].Money.toString(),inline:true},
			{name:"Charge",value:rolistes[NomDonne].Weight.toString()+"kg",inline:true},
			{name:"Vie",value:rolistes[NomDonne].PV.Actuel+"/"+rolistes[NomDonne].PV.Total},
			{name:"__Statistiques :__",value:"Physique : "+rolistes[NomDonne].Stats.PHY.toString()+"\r\nMental : "+rolistes[NomDonne].Stats.MEN.toString()+"\r\nIntelligence : "+rolistes[NomDonne].Stats.INT.toString()+"\r\nSocial : "+rolistes[NomDonne].Stats.SOC.toString()+"\r\nChance : "+rolistes[NomDonne].Stats.CHA.toString()},
		)
		//ARMES
		//Principale
		EmbArmes = "__Principale :__\r\nNom : " + rolistes[NomDonne].Weapons.Principale.Nom + "\r\nType : " + rolistes[NomDonne].Weapons.Principale.Type + "\r\nMains : " + rolistes[NomDonne].Weapons.Principale.Hand + "\r\nPoids : " + rolistes[NomDonne].Weapons.Principale.Weight + "\r\nDégâts : " + rolistes[NomDonne].Weapons.Principale.Damage + "\r\nPrécision : " + rolistes[NomDonne].Weapons.Principale.Precision;

		//Arme à munitions ?
		if(typeof rolistes[NomDonne].Weapons.Principale.Munitions !== "undefined")
		{
      ...
      await interaction.reply(
        {content:"Le joueur choisi n'a pas été trouvé (Recherche par Nom).", ephemeral:true}
      );
  },
};
